...
//     <button className="block md:hidden lg:block bg-blue-500 text-white font-bold py-2 px-4 rounded">
//         Click Me
//     </button>
// </body>
//     </div>
...
const Page = () => {
  ...
  return (
    <>
      <div className="signUpwrapper">
        <div className="formWrapper">
          <div className="left">
            ...
            <Link href={"/signin"}>
              <Button className='block lg:block border-zinc-500 text-zinc-100 hover:border-zinc-200 hover:text-zinc-100 transition-colors border border-r-4 border-s-4 rounded-full px-6'>Sign In</Button>
            </Link>
          </div>
          ...
          <div className='right'>
            <h3 className='text-center text-2xl font-semibold'>Create a new account.</h3>
      ...
      <Link href={"/signin"}>
        <p className='lg:hidden text-primary text-center grid grid-col p-2 '>Already have an account?
          <Button className='block border-zinc-500 text-zinc-100 hover:border-zinc-200 hover:text-zinc-100 transition-colors border border-r-4 border-s-4 rounded-full  px-2 h-full w-full items-center font-bold '>Sign In</Button>
        </p>
      </Link>
